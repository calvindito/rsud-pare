    ...
    Route::middleware('verify.permission')->group(function () {
        ...
        Route::prefix('collection')->namespace('Collection')->group(function () {
            Route::prefix('outpatient')->group(function () {
                ...
                Route::match(['get', 'post'], 'recipe/{id}', 'OutpatientController@recipe');
                ...
                Route::match(['get', 'post'], 'checkout/{id}', 'OutpatientController@checkout');
            ...
            Route::prefix('emergency-department')->group(function () {
                ...
                Route::match(['get', 'post'], 'operating-room/{id}', 'EmergencyDepartmentController@operatingRoom');
