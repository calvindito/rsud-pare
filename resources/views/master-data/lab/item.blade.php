<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Master Data - Laboratorium - <span class="fw-normal">Item</span>
            </h5>
        </div>
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <select class="form-select" name="lab_category_id" id="lab_category_id">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Grup</label>
                        <div class="col-md-9">
                            <select class="form-select" name="lab_item_group_id" id="lab_item_group_id">
                                <option value="">-- Pilih --</option>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/lab/item/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/lab/item/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/lab/item/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#lab_category_id').val(response.lab_category_id);
                $('#lab_item_group_id').val(response.lab_item_group_id);
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("master-data/lab/item/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/lab/item/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
