<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Master Data - Laboratorium - <span class="fw-normal">Item Option</span>
            </h5>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Nilai <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <input type="number" class="form-control" name="score" id="score" placeholder="Masukan nilai">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Label <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/lab/item-option/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
            ...
            columns: [
                ...
                { data: 'score', name: 'score', orderable: true, searchable: false, className: 'align-middle' },
                { data: 'label', name: 'label', orderable: true, searchable: true, className: 'align-middle' },
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/lab/item-option/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/lab/item-option/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("master-data/lab/item-option/update-data") }}',
            type: 'PATCH',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/lab/item-option/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
