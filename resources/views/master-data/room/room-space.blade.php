<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Master Data - Kamar - <span class="fw-normal">Ruang Kamar</span>
            </h5>
        </div>
            ...
            <table class="table table-bordered table-hover table-xs display" id="datatable-serverside">
                <thead class="text-bg-light">
                    <tr>
                        ...
                        <th nowrap>Nama</th>
                        <th nowrap>Kelas Kamar</th>
                        <th nowrap>Fasilitas</th>
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Kelas Kamar <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <select class="form-select select2-basic" name="room_type_id" id="room_type_id">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Fasilitas</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="facility" id="facility" placeholder="Masukan fasilitas">
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/room/room-space/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
            ...
            columns: [
                ...
                { data: 'facility', name: 'facility', orderable: true, searchable: true, className: 'align-middle' },
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/room/room-space/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/room/room-space/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#room_type_id').val(response.room_type_id).change();
                $('#name').val(response.name);
                $('#facility').val(response.facility);
            },
            error: function(response) {
                onLoading('close', '.modal-content');
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/room/room-space/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
