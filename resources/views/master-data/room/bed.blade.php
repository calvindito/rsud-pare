<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Master Data - Kamar - <span class="fw-normal">Tempat Tidur</span>
            </h5>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Ruang Kamar <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <select class="form-select select2-basic" name="room_space_id" id="room_space_id">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Kata Kunci</label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="keywords" id="keywords" placeholder="Masukan kata kunci">
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/room/bed/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/room/bed/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/room/bed/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#room_space_id').val(response.room_space_id).change();
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("master-data/room/bed/update-data") }}',
            type: 'PATCH',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/room/bed/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
