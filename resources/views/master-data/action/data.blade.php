    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            columns: [
                ...
                { data: 'created_at', name: 'fee_nursing_care', orderable: true, searchable: false, className: 'align-middle' },
                { data: 'created_at', name: 'fee_monitoring', orderable: true, searchable: false, className: 'align-middle' },
