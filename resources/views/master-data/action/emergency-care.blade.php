<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Master Data - Tindakan - <span class="fw-normal">Rawat Darurat</span>
            </h5>
        </div>
            ...
            <table class="table table-bordered table-hover table-xs display" id="datatable-serverside">
                <thead class="text-bg-light">
                    <tr>
                        ...
                        <th nowrap>Nama</th>
                        <th nowrap>Jrs</th>
                        <th nowrap>Jaspel Dokter</th>
                        <th nowrap>Jaspel Askep</th>
                        <th nowrap>Tarif</th>
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="description" id="description" style="resize:none;" placeholder="Masukan deskripsi"></textarea>
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/action/emergency-care/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
            ...
            columns: [
                ...
                { data: 'service_doctor', name: 'service_doctor', orderable: true, searchable: false, className: 'align-middle' },
                { data: 'service_nursing_care', name: 'service_nursing_care', orderable: true, searchable: false, className: 'align-middle' },
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/action/emergency-care/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/action/emergency-care/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#service_doctor').val(response.service_doctor);
                $('#service_nursing_care').val(response.service_nursing_care);
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("master-data/action/emergency-care/update-data") }}',
            type: 'PATCH',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/action/emergency-care/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
