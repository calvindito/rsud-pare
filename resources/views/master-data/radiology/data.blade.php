<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Master Data - Radiologi - <span class="fw-normal">Data</span>
            </h5>
        </div>
            ...
            <table class="table table-bordered table-hover table-xs display" id="datatable-serverside">
                <thead class="text-bg-light">
                    <tr>
                        ...
                        <th nowrap>Tindakan Penunjang</th>
                        <th nowrap>Kode</th>
                        <th nowrap>Jenis</th>
                        <th nowrap>Objek</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Tindakan Penunjang <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <select class="form-select" name="action_supporting_id" id="action_supporting_id">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="type" id="type" placeholder="Masukan jenis">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Objek <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="object" id="object" placeholder="Masukan objek">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Proyeksi <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <input type="text" class="form-control" name="projection" id="projection" placeholder="Masukan proyeksi">
                        </div>
                    </div>
                </form>
            </div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("master-data/radiology/data/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("master-data/radiology/data/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("master-data/radiology/data/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#action_supporting_id').val(response.action_supporting_id);
                $('#code').val(response.code);
                $('#type').val(response.type);
                $('#object').val(response.object);
                $('#projection').val(response.projection);
            },
            error: function(response) {
                onLoading('close', '.modal-content');
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("master-data/radiology/data/update-data") }}',
            type: 'PATCH',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("master-data/radiology/data/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
