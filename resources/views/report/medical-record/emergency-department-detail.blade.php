<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Laporan - Rekam Medis - IGD - <span class="fw-normal">Detail</span>
            </h5>
        </div>
        <div class="my-auto ms-auto">
            <a href="{{ url('report/medical-record/emergency-department') }}" class="btn btn-flat-primary">Kembali ke Daftar</a>
        </div>
    </div>
</div>
                        ...
                        <table class="table table-bordered">
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $emergencyDepartment->code() }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">User</th>
                                    <td>{{ $emergencyDepartment->user->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Pasien</th>
                                    <td>{{ $emergencyDepartment->patient->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">No RM</th>
                                    <td>{{ $emergencyDepartment->patient->no_medical_record ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">UPF</th>
                                    <td>{{ $emergencyDepartment->functionalService->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Apotek</th>
                                    <td>{{ $emergencyDepartment->dispensary->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Dokter</th>
                                    <td>{{ $emergencyDepartment->doctor->name ?? '-' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Ref</th>
                                    <td>{{ isset($emergencyDepartment->parent) ? $emergencyDepartment->parent->code() : 'Tidak Ada' }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Golongan</th>
                                    <td>{{ $emergencyDepartment->type_format_result }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Tanggal Dibuat</th>
                                    <td>{{ $emergencyDepartment->created_at }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Tanggal Masuk</th>
                                    <td>{{ $emergencyDepartment->date_of_entry }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Tanggal Keluar</th>
                                    <td>{{ $emergencyDepartment->date_of_out }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Hasil</th>
                                    <td>{{ $emergencyDepartment->ending_format_result }}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Pembayaran</th>
                                    <td>{!! $emergencyDepartment->paid() !!}</td>
                                </tr>
                                <tr>
                                    <th class="bg-light" width="25%">Status</th>
                                    <td>{!! $emergencyDepartment->status() !!}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            <tr>
                                <th>Layanan</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->actionService) }}</td>
                            </tr>
                            <tr>
                                <th>Non Operative</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->actionNonOperative) }}</td>
                            </tr>
                            <tr>
                                <th>Penunjang</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->actionSupporting) }}</td>
                            </tr>
                            <tr>
                                <th>Obat & Alkes</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->actionHealth) }}</td>
                            </tr>
                            <tr>
                                <th>Lainnya</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->actionOther) }}</td>
                            </tr>
                            <tr>
                                <th>Paket</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->actionPackage) }}</td>
                            </tr>
                            <tr>
                                <th>Perawat</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->emergencyDepartmentNursing->sum('fee')) }}</td>
                            </tr>
                        </table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="text" class="form-control number-format" value="{{ $emergencyDepartment->observation->nominal ?? 0 }}" placeholder="0" disabled>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <div class="input-group">
                                                                        <span class="input-group-text">Rp</span>
                                                                        <input type="text" class="form-control number-format" value="{{ $emergencyDepartment->supervision_doctor->nominal ?? 0 }}" placeholder="0" disabled>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr class="bg-light">
                                                                ...
                                                                @foreach($medicalService as $ms)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="align-middle">
                                                                            <div class="input-group">
                                                                                <span class="input-group-text">Rp</span>
                                                                                <input type="text" class="form-control number-format" value="{{ $check->nominal ?? 0 }}" placeholder="0" disabled>
                                                    ...
                                                    <tr>
                                                        <td class="align-middle">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="text" class="form-control number-format" value="{{ $emergencyDepartmentPackage[0]->nominal ?? 0 }}" placeholder="0" disabled>
                                                            </div>
                                                        </td>
                                                        <td class="align-middle">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="text" class="form-control number-format" value="{{ $emergencyDepartmentPackage[1]->nominal ?? 0 }}" placeholder="0" disabled>
                                                            </div>
                                                        </td>
                                                        <td class="align-middle">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-text">Rp</span>
                                                                <input type="text" class="form-control number-format" value="{{ $emergencyDepartmentPackage[2]->nominal ?? 0 }}" placeholder="0" disabled>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            <tr>
                                <th>Tindakan</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->totalAction()) }}</td>
                            </tr>
                            <tr>
                                <th>Laboratorium</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->lab) }}</td>
                            </tr>
                            <tr>
                                <th>Radiologi</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->radiology) }}</td>
                            </tr>
                            <tr>
                                <th>Operasi</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->operation) }}</td>
                            </tr>
                            <tr>
                                <th>Resep</th>
                                <td>{{ Simrs::formatRupiah($emergencyDepartment->costBreakdown()->dispensaryRequest) }}</td>
                            </tr>
                        </table>
                        @if($emergencyDepartment->total() > 0)
                            <div class="form-group"><hr></div>
                            <div class="text-center">
                                <h6 class="text-uppercase fw-bold">Total Keseluruhan</h6>
                                <h3 class="text-primary fw-bold mb-0">{{ Simrs::formatRupiah($emergencyDepartment->total()) }}</h3>
                            </div>
                            <div class="form-group"><hr></div>
                            <div class="text-center fst-italic">Terbilang : {{ Simrs::numerator($emergencyDepartment->total()) }}</div>
                        @endif
                    </div>
                </div>
            </div>
