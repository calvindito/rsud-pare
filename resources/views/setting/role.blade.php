<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Pengaturan - <span class="fw-normal">Hak Akses</span>
            </h5>
        </div>
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-1">Nama <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-11">
...
<script>
    ...
    function onReset() {
        ...
        $('input[name="role_access_menu[]"]').attr('checked', false);
    }
    ...
    function createData() {
        $.ajax({
            url: '{{ url("setting/role/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("setting/role/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("setting/role/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
