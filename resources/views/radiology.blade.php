<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                <span class="fw-normal">Radiologi</span>
            </h5>
        </div>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            columns: [
                ...
                { data: 'date_of_request', name: 'date_of_request', orderable: true, searchable: false, className: 'align-middle' },
                { data: 'radiology_action', name: 'radiology_action', orderable: false, searchable: true, className: 'align-middle' },
