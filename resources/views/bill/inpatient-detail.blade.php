<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Tagihan - Rawat Inap - <span class="fw-normal">Detail</span>
            </h5>
        </div>
        <div class="my-auto ms-auto">
            <a href="{{ url('bill/inpatient') }}" class="btn btn-flat-primary">Kembali ke Daftar</a>
        </div>
    </div>
</div>
<div class="content pt-0">
    ...
    <form id="form-data">
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control number-format" name="observation_nominal" id="observation_nominal" value="{{ $inpatient->observation->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" class="form-control number-format" name="fee_room" id="fee_room" value="{{ $inpatient->fee_room ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" class="form-control number-format" name="supervision_doctor_nominal" id="supervision_doctor_nominal" value="{{ $inpatient->supervision_doctor->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                        </div>
                                    </td>
                                    ...
                                    <td class="align-middle">
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" class="form-control number-format" name="fee_nursing_care" id="fee_nursing_care" value="{{ $inpatient->fee_nursing_care ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="input-group">
                                            <span class="input-group-text">Rp</span>
                                            <input type="text" class="form-control number-format" name="fee_nutritional_care" id="fee_nutritional_care" value="{{ $inpatient->fee_nutritional_care ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                            <select class="form-select w-auto flex-grow-0" name="fee_nutritional_care_qty" id="fee_nutritional_care_qty" onchange="total()" disabled>
                                                @for($i = 1; $i <= 100; $i++)
                                ...
                                @if($medicalService->count() > 0)
                                    @foreach($medicalService as $ms)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <select class="form-select" name="is_emergency_care_doctor_id[]" disabled>
                                                    @foreach($doctor as $key => $d)
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="is_emergency_care_nominal[]" value="{{ $check->emergency_care->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                    <select class="form-select w-auto flex-grow-0" name="is_emergency_care_qty[]" onchange="total()" disabled>
                                                        @for($i = 1; $i <= 100; $i++)
                                            ...
                                            <td class="align-middle">
                                                <select class="form-select" name="is_hospitalization_doctor_id[]" disabled>
                                                    @foreach($doctor as $key => $d)
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="is_hospitalization_nominal[]" value="{{ $check->hospitalization->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                    <select class="form-select w-auto flex-grow-0" name="is_hospitalization_qty[]" onchange="total()" disabled>
                                                        @for($i = 1; $i <= 100; $i++)
                                    ...
                                    @foreach($actionOperative as $ao)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle" width="25%">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="io_nominal[]" value="{{ $check->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @foreach($actionNonOperative as $ano)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="ino_emergency_care[]" value="{{ $check->emergency_care ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="ino_hospitalization[]" value="{{ $check->hospitalization ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @foreach($actionSupporting as $as)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="is_emergency_care[]" value="{{ $check->emergency_care ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <select class="form-select" name="is_doctor_id[]" disabled>
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="is_hospitalization[]" value="{{ $check->hospitalization ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @foreach($tool as $key => $t)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="ih_emergency_care[]" value="{{ $check->emergency_care ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="ih_hospitalization[]" value="{{ $check->hospitalization ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
                                    ...
                                    @foreach($actionOther as $ao)
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="io_emergency_care[]" value="{{ $check->emergency_care ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                </div>
                                            </td>
                                            <td class="align-middle">
                                                <div class="input-group">
                                                    <span class="input-group-text">Rp</span>
                                                    <input type="text" class="form-control number-format" name="io_hospitalization[]" value="{{ $check->hospitalization ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                                    <select class="form-select w-auto flex-grow-0" name="io_hospitalization_qty[]" onchange="total()" disabled>
                                                        @for($i = 1; $i <= 100; $i++)
                            ...
                            <tbody>
                                ...
                                @if($inpatient->inpatientNursing->count() > 0)
                                    @foreach($inpatient->inpatientNursing as $key => $in)
                                        @php $totalActionNursing += $in->fee; @endphp
                                        <tr>
                        ...
                        <tr>
                            <td class="align-middle">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" class="form-control number-format" name="inpatient_package[]" value="{{ $inpatientPackage[0]->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                </div>
                            </td>
                            <td class="align-middle">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" class="form-control number-format" name="inpatient_package[]" value="{{ $inpatientPackage[1]->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                </div>
                            </td>
                            <td class="align-middle">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text">Rp</span>
                                    <input type="text" class="form-control number-format" name="inpatient_package[]" value="{{ $inpatientPackage[2]->nominal ?? 0 }}" onkeyup="total()" placeholder="0" disabled>
                                </div>
                            </td>
                        </tr>
                    </tbody>
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-end">
                    @if($inpatient->paid == false)
                        <button type="button" class="btn btn-success" onclick="submitted()">
                            <i class="ph-check-circle me-2"></i>
                            Tandai Sudah Terbayar
                        </button>
                    @else
                        <a href="{{ url('bill/inpatient/print/' . $inpatient->id) }}" target="_blank" class="btn btn-teal">
...
<script>
    ...
    function total() {
        ...
        var calculateInpatientFirst = parseFloat(feeRoom + feeNursingCare + (feeNutritionalCare * feeNutritionalCareQty) + totalActionNursing);
    ...
    function submitted() {
        $.ajax({
            url: '{{ url("bill/inpatient/detail/" . $inpatient->id) }}',
            type: 'POST',
            dataType: 'JSON',
            headers: {
            ...
            success: function(response) {
                ...
                if(response.code == 200) {
                    ...
                    swalInit.fire({
                        ...
                        window.location.replace('{{ url("bill/inpatient/detail/" . $inpatient->id) }}');
                    });
                } else {
                    swalInit.fire({
                        title: 'Error',
