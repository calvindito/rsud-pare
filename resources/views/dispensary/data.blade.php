<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Apotek - <span class="fw-normal">Data</span>
            </h5>
        </div>
            ...
            <div class="modal-body">
                ...
                <form id="form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-3">Lokasi <span class="text-danger fw-bold">*</span></label>
                        <div class="col-md-9">
                            <select class="form-select" name="dispensary_location_id" id="dispensary_location_id">
                                <option value="">-- Pilih --</option>
                                @foreach($dispensaryLocation as $dl)
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("dispensary/data/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
            ...
            columns: [
                ...
                { data: 'dispensary_location_name', name: 'dispensary_location_name', orderable: false, searchable: true, className: 'align-middle' },
    ...
    function createData() {
        $.ajax({
            url: '{{ url("dispensary/data/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
    ...
    function showDataUpdate(id) {
        $.ajax({
            url: '{{ url("dispensary/data/show-data") }}',
            type: 'GET',
            dataType: 'JSON',
            data: {
                id: id
            ...
            success: function(response) {
                ...
                $('#dispensary_location_id').val(response.dispensary_location_id);
    ...
    function updateData() {
        $.ajax({
            url: '{{ url("dispensary/data/update-data") }}',
            type: 'POST',
            dataType: 'JSON',
            data: $('#form-data').serialize(),
            headers: {
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("dispensary/data/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
