<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Apotek - <span class="fw-normal">Stok</span>
            </h5>
        </div>
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-end">
                <button class="btn btn-primary" id="btn-create" onclick="createData()">
                    <i class="ph-plus-circle me-1"></i>
                    Simpan Data
                </button>
            </div>
...
<script>
    ...
    function loadData() {
        window.gDataTable = $('#datatable-serverside').DataTable({
            ...
            order: [[0, 'desc']],
            ajax: {
                url: '{{ url("dispensary/stock/datatable") }}',
                dataType: 'JSON',
                beforeSend: function() {
    ...
    function createData() {
        $.ajax({
            url: '{{ url("dispensary/stock/create-data") }}',
            type: 'POST',
            dataType: 'JSON',
        ...
        var notyConfirm = new Noty({
            ...
            buttons: [
                ...
                Noty.button('Hapus', 'btn btn-danger ms-2', function () {
                    $.ajax({
                        url: '{{ url("dispensary/stock/destroy-data") }}',
                        type: 'DELETE',
                        dataType: 'JSON',
                        data: {
                            id: id
