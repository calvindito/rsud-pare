                ...
                <div id="plus-destroy-item">
                    @foreach($dispensaryRequest as $dr)
                        <div id="item">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        @if(!empty($dr->status) || $inpatient->dispensary_id != $dr->dispensary_id)
                                            <input type="hidden" name="dr_dispensary_item_stock_id[]" value="{{ $dr->dispensary_item_stock_id }}">
                                        @endif
                                        @if($inpatient->dispensary_id == $dr->dispensary_id)
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        @endif
                                        @if($inpatient->dispensary_id == $dr->dispensary_id)
                                            <input type="number" class="form-control" name="dr_qty[]" value="{{ $dr->qty }}" placeholder="Kuantitas" {{ !empty($dr->status) || $inpatient->status != 1 ? 'disabled' : '' }}>
                                        @else
                            ...
                            @if($inpatient->dispensary_id == $dr->dispensary_id)
                                <div class="form-group">
                                    <input type="text" class="form-control" name="dr_consumed[]" value="{{ $dr->consumed }}" placeholder="Aturan pemakaian ..." {{ !empty($dr->status) || $inpatient->status != 1 ? 'disabled' : '' }}>
                                </div>
                            @else
                                <div class="form-group">
        ...
        var formElement = $(`
            <div id="item">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="text" class="form-control" value="{{ $inpatient->dispensary->name ?? '-' }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-1">
                        <div class="form-group">
