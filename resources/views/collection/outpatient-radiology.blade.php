<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Pendataan - Rawat Jalan - <span class="fw-normal">Radiologi</span>
            </h5>
        </div>
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle" width="1%">:</td>
                        <td class="align-middle">{{ $outpatient->presence_format_result }}</td>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                @if($rr->status == 3)
                                                    <div class="modal-footer justify-content-end">
                                                        <a href="{{ url('collection/outpatient/radiology/print/' . $rr->id) }}" target="_blank" class="btn btn-teal">
...
<script>
    ...
    function createData() {
        $.ajax({
            url: '{{ url("collection/outpatient/radiology/" . $outpatient->id) }}',
            type: 'POST',
            dataType: 'JSON',
            ...
            success: function(response) {
                ...
                if(response.code == 200) {
                    ...
                    swalInit.fire({
                        ...
                        window.location.replace('{{ url("collection/outpatient/radiology/" . $outpatient->id) }}');
                    });
