<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Pendataan - IGD - <span class="fw-normal">Diagnosa</span>
            </h5>
        </div>
...
<script>
    ...
    function submitted() {
        $.ajax({
            url: '{{ url("collection/emergency-department/diagnosis/" . $emergencyDepartment->id) }}',
            type: 'POST',
            dataType: 'JSON',
            ...
            success: function(response) {
                ...
                if(response.code == 200) {
                    ...
                    swalInit.fire({
                        ...
                        window.location.replace('{{ url("collection/emergency-department/diagnosis/" . $emergencyDepartment->id) }}');
                    });
