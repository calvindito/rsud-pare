<div class="page-header page-header-light border rounded mb-3">
    <div class="page-header-content d-flex">
        <div class="page-title">
            <h5 class="mb-0">
                Pendataan - IGD - <span class="fw-normal">Laboratorium</span>
            </h5>
        </div>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                @if($lr->status == 3)
                                                    <div class="modal-footer justify-content-end">
                                                        <a href="{{ url('collection/emergency-department/lab/print/' . $lr->id . '?slug=result') }}" target="_blank" class="btn btn-teal">
                                                            <i class="ph-printer me-1"></i>
                                                            Cetak Hasil
                                                        </a>
                                                        <a href="{{ url('collection/emergency-department/lab/print/' . $lr->id . '?slug=detail') }}" target="_blank" class="btn btn-teal">
...
<script>
    ...
    function createData() {
        $.ajax({
            url: '{{ url("collection/emergency-department/lab/" . $emergencyDepartment->id) }}',
            type: 'POST',
            dataType: 'JSON',
            ...
            success: function(response) {
                ...
                if(response.code == 200) {
                    ...
                    swalInit.fire({
                        ...
                        window.location.replace('{{ url("collection/emergency-department/lab/" . $emergencyDepartment->id) }}');
                    });
