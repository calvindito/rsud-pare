    ...
    <div class="row">
            ...
            <form id="form-chart-3">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                        ...
                        <div class="ms-sm-auto my-sm-auto">
                            <div class="hstack gap-3 justify-content-between">
                                <span>Tahun {{ date('Y', strtotime('-5 years')) }} s/d Tahun {{ date('Y') }}</span>
        ...
        <div class="col-md-12">
            <form id="form-chart-4">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                        <h6 class="py-sm-3 mb-sm-0">Kunjungan Rawat Jalan Per Tahun</h6>
                        <div class="ms-sm-auto my-sm-auto">
                            <div class="hstack gap-3 justify-content-between">
                                <div class="input-group">
                                    <span class="input-group-text">Filter</span>
        ...
        <div class="col-md-12">
            <form id="form-chart-5">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                        <h6 class="py-sm-3 mb-sm-0">Kunjungan Rawat Inap Per Tahun</h6>
                        <div class="ms-sm-auto my-sm-auto">
                            <div class="hstack gap-3 justify-content-between">
                                <div class="input-group">
                                    <span class="input-group-text">Filter</span>
        ...
        <div class="col-md-12">
            <form id="form-chart-6">
                <div class="card">
                    <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                        <h6 class="py-sm-3 mb-sm-0">Kunjungan IGD Per Tahun</h6>
                        <div class="ms-sm-auto my-sm-auto">
                            <div class="hstack gap-3 justify-content-between">
                                <div class="input-group">
                                    <span class="input-group-text">Filter</span>
