...
class InstallationController extends Controller
{
    ...
    {
        $data = [
            'content' => 'master-data.general.installation'
        ];
    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('action', function (Installation $query) {
                return '
                    <div class="btn-group">
    ...
    public function createData(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            try {
                $createData = Installation::create([
                    'name' => $request->name
                ]);
    ...
    public function updateData(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            try {
                $updateData = Installation::findOrFail($id)->update([
                    'name' => $request->name
                ]);
