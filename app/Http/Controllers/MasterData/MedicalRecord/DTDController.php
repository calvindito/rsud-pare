...
class DTDController extends Controller
{
    ...
    {
        $data = [
            'content' => 'master-data.medical-record.dtd'
        ];
    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('action', function (DTD $query) {
                return '
                    <div class="btn-group">
    ...
    public function updateData(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            try {
                $updateData = DTD::findOrFail($id)->update([
                    'code' => $request->code,
                    'name' => $request->name
                ]);
