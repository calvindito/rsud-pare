...
class LocationController extends Controller
{
    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::eloquent($data)
            ...
            ->addColumn('action', function (DispensaryLocation $query) {
                return '
                    <div class="btn-group">
    ...
    public function createData(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            try {
                $createData = DispensaryLocation::create([
                    'name' => $request->name
                ]);
    ...
    {
        $id = $request->id;
        $data = DispensaryLocation::findOrFail($id);
    ...
    public function updateData(Request $request)
    {
        ...
        if ($validation->fails()) {
            ...
            try {
                DispensaryLocation::findOrFail($id)->update([
                    'name' => $request->name
                ]);
